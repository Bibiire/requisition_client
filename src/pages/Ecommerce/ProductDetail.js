                    ...
                    <Row>
                            ...
                            <Col md={8} xs={9}>
                              ...
                              <Row className="text-center mt-2">
                                <Col sm={6}>
                                  ...
                                  >
                                    <i className="mdi mdi-cart mr-2"></i> Add to
                                    cart
                                  </Button>
                                </Col>
                                <Col sm={6}>
                                  ...
                                  >
                                    <i className="mdi mdi-shopping mr-2"></i>Buy
                                    now
                                  </Button>
                                </Col>
                              </Row>
                      ...
                      <Col xl={7}>
                        <div className="mt-4 mt-xl-3">
                          ...
                          <h5 className="mt-2">
                            <del className="text-muted mr-2">$252</del>$240{' '}
                            ...
                            <Col md={6}>
                              <div>
                                <h5 className="font-size-14">
                                  <i className="mdi mdi-location"></i> Delivery
                                  location
                                </h5>
                          ...
                          <Media body>
                            ...
                            <ul className="list-inline product-review-link mb-0">
                              <li className="list-inline-item">
                                <Link to="#">
                                  <i className="mdi mdi-thumb-up align-middle mr-1"></i>{' '}
                                  Like
                                </Link>
                              </li>
                              <li className="list-inline-item ml-1">
                                <Link to="#">
                                  <i className="mdi mdi-message-text align-middle mr-1"></i>{' '}
                                  Comment
                                </Link>
                              </li>
                            </ul>
                          </Media>
                          <p className="float-sm-right font-size-12">
                            11 Feb, 2020
                          </p>
                        </Media>
