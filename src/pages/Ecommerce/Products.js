                  ...
                  <CardBody>
                    ...
                    >
                      ...
                      <div className="categories-group-card">
                        ...
                        >
                          <i className="mdi mdi-hanger font-size-16 align-middle mr-2"></i>{' '}
                          Fashion
                          <i
                            className={
                      ...
                      <div className="categories-group-card">
                        ...
                        >
                          <i className="mdi mdi-pinwheel-outline font-size-16 align-middle mr-2"></i>{' '}
                          Baby & Kids
                          <i
                            className={
                              this.state.baby === true
                                ? 'mdi mdi-minus float-right accor-minus-icon'
                                : 'mdi mdi-plus float-right accor-plus-icon'
                            }
                          ></i>
                      ...
                      <div className="categories-group-card">
                        ...
                        >
                          <i className="mdi mdi-dumbbell font-size-16 align-middle mr-2"></i>{' '}
                          Fitness
                          <i
                            className={
