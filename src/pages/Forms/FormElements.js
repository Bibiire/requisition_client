              ...
              <Col lg={6}>
                <Card>
                  <CardBody>
                    ...
                    <p className="card-title-desc">
                      Set heights using classNames like{' '}
              ...
              <Col lg={6}>
                <Card>
                  <CardBody>
                    ...
                    <p className="card-title-desc">
                      The file input is the most gnarly of the bunch and
                      requires additional JavaScript if you’d like to hook them
                      up with functional <em>Choose file…</em> and selected file
                      name text.
                    </p>
