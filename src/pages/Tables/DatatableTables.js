              ...
              <Col xs={12}>
                <Card>
                  <CardBody>
                    ...
                    <p className="card-title-desc">Toggle Column Example</p>
                    ...
                    >
                      {(props) => (
                        <div>
                          ...
                          <hr />
                          <BootstrapTable striped {...props.baseProps} />
                        </div>
                      )}
                    </ToolkitProvider>
                  </CardBody>
              ...
              <Col xs={12}>
                <Card>
                  <CardBody>
                    ...
                    <p className="card-title-desc">
                      This example shows the multi option. Note how a click on a
                      row will toggle its selected state without effecting other
                      rows, unlike the os and single options shown in other
                      examples.
                    </p>
                    <BootstrapTable
                      keyField="id"
