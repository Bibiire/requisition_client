                    ...
                    <Row>
                      <Col lg={6}>
                        <div>
                          ...
                          <div className="mt-1">
                            <Badge className="badge-soft-primary mr-1">
                              Primary
                            </Badge>
                            ...
                            <Badge className="badge-soft-warning mr-1">
                              Warning
                            </Badge>
                      ...
                      <Col lg={6}>
                        <div className="mt-4 mt-lg-0">
                          ...
                          <p className="card-title-desc">
                            Use the <code>.badge-pill</code> modifier class to
                          ...
                          <div className="mt-1">
                            <Badge pill className="badge-soft-primary mr-1">
                              Primary
                            </Badge>
                            <Badge pill className="badge-soft-success mr-1">
                              Success
                            </Badge>
                            <Badge pill className="badge-soft-info mr-1">
                              Info
                            </Badge>
                            <Badge pill className="badge-soft-warning mr-1">
                              Warning
                            </Badge>
                            <Badge pill className="badge-soft-danger mr-1">
                              Danger
                            </Badge>
                            <Badge pill className="badge-soft-dark mr-1">
                              Dark
                            </Badge>
                          </div>
                        </div>
